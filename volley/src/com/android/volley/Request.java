...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    /** Whether or not use offline cache for response, if network is not available. */
    ...
    /**
     * Set whether or not use offline cache for response, if network is not available.
     *
     * @return This Request object to allow for chaining.
     */
    public final Request<?> setUseOfflineCache(boolean useOfflineCache) {
        mUseOfflineCache = useOfflineCache;
        return this;
    }

    /**
     * Returns true if get response from cache if network is not available.
     */
    public final boolean shouldUseOfflineCache() {
